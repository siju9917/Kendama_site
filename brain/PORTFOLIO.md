...
| **OpenAPI Breaking-Change Lens** (`products/openapi-lens/`) | VS Code extension that classifies breaking changes in OpenAPI schemas inline as you edit. | `build` (Phase 0 done + critique-panel cleared + 5.7.5 bug-hunt done; awaiting Proposal #3 auto-proceed 2026-06-13) | Phase 0 complete: pure TypeScript diff engine, 106/106 tests, 27 BREAKING/INFO rules, YAML + JSON + Swagger 2.0 support, property-level diff, circular $ref protection, components/parameters $ref resolution. VS Code extension shell not yet built. | 2026-06-06: Full 14-critic panel + 5.7.2 escalating critique PASSED. Post-panel 5.7.5 bug-hunt found `$ref` parameter resolution gap (fixed, 4 new tests). All P0/P1/P2 findings resolved. See `CRITIQUE_LOG.md`. | Not yet — Proposal #3 auto-proceeds 2026-06-13; marketplace publisher reg needed (NEED #10). | $0 (pre-launch) | On `main`; human gate: Proposal #3 and NEED #10. |
