...
- **Build green:** **1062/1062 tests** (BidDiff 586/586 + openapi-lens 476/476).
...
8. ~~**D5 Phase 0 engine**~~ — **DONE + hardened 2026-06-06.** `products/openapi-lens/` — 473/473 tests
   ...
   items-additionalProperties spurious-event guard fix (round 20)). VS Code extension scaffold (Phase 1)
