...
- **Build green:** **1552/1552 tests** (BidDiff 586/586 + openapi-lens 966/966). MILESTONE: 100% adversarial coverage for all 100+ OapiChangeTypes (rounds 43-53). Round 54: enum cross-level consistency matrix (18 tests). Round 55: constraint direction matrix (30 tests). Round 56: additionalProperties cross-level matrix (12 tests, request/response × body/property/items × close/open).
