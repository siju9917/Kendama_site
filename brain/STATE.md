...
- **Build green:** **1584/1584 tests** (BidDiff 586/586 + openapi-lens 998/998). Rounds 54-57: cross-level consistency matrices (87 tests). Round 58: security:[] Phase 2 gap locked (2 tests). Round 59: OAS 3.1 type-array nullable normalization (3 tests — verifies cross-version equivalence, locked INFO direction for response nullable true→false).
