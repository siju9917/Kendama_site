...
- **Build green:** **892/892 tests** (BidDiff 586/586 + openapi-lens 306/306).
...
8. ~~**D5 Phase 0 engine**~~ — **DONE + hardened 2026-06-06.** `products/openapi-lens/` — 306/306 tests.
...
- **D5 Phase 0 engine is in `products/openapi-lens/`** — 306 tests, all passing.
