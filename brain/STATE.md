...
- **Build green:** **1014/1014 tests** (BidDiff 586/586 + openapi-lens 428/428).
...
8. ~~**D5 Phase 0 engine**~~ — **DONE + hardened 2026-06-06.** `products/openapi-lens/` — 428/428 tests
   (rounds 5–15: allOf constraint inheritance, top-level body schema constraints/format/enum,
   ...
   for 12 change types (round 15)). VS Code extension scaffold (Phase 1)
