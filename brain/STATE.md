...
- **Build green:** **1059/1059 tests** (BidDiff 586/586 + openapi-lens 473/473).
...
8. ~~**D5 Phase 0 engine**~~ — **DONE + hardened 2026-06-06.** `products/openapi-lens/` — 473/473 tests
   ...
   enum order-sensitivity false-positive fix — enumSetsEqual() (round 19)). VS Code extension scaffold (Phase 1)
