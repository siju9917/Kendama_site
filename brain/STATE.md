...
8. ~~**D5 Phase 0 engine**~~ — **DONE + hardened 2026-06-06.** `products/openapi-lens/` — 458/458 tests
   (rounds 5–17: allOf constraint inheritance, top-level body schema constraints/format/enum,
