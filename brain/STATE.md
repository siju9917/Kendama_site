...
- **Build green:** **1028/1028 tests** (BidDiff 586/586 + openapi-lens 442/442).
...
8. ~~**D5 Phase 0 engine**~~ — **DONE + hardened 2026-06-06.** `products/openapi-lens/` — 442/442 tests
   (rounds 5–16: allOf constraint inheritance, top-level body schema constraints/format/enum,
   ...
   for 12 change types (round 15), additionalProperties detection (round 16)). VS Code extension scaffold (Phase 1)
