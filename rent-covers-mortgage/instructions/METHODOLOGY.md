...
- **Default condo/townhome HOA = $300/mo** when not provided (SFH/multifamily default to $0 HOA). Insurance and CapEx auto-scale with price: **insurance ≈ SFH 0.30%/yr · condo 0.15%/yr (min $40 — an HO-6 policy, since the HOA covers the building) · multifamily 0.35%/yr**; CapEx ≈ 1.0%/yr of price. *Override with real figures for finalists; for high-rise condos the real HOA is often much higher (~$500+).*
